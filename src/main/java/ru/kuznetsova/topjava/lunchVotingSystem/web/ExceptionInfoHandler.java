...
import ru.kuznetsova.topjava.lunchVotingSystem.util.ValidationUtil;
import ru.kuznetsova.topjava.lunchVotingSystem.util.exception.ApplicationException;
import ru.kuznetsova.topjava.lunchVotingSystem.util.exception.ErrorInfo;
import ru.kuznetsova.topjava.lunchVotingSystem.util.exception.ErrorType;
import ru.kuznetsova.topjava.lunchVotingSystem.util.exception.IllegalRequestDataException;

import javax.servlet.http.HttpServletRequest;
import java.util.Map;
import java.util.Optional;

import static ru.kuznetsova.topjava.lunchVotingSystem.util.exception.ErrorType.*;
